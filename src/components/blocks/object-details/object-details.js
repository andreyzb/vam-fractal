...
const html = [
  '<span class="b-object-details__cell-concealer-text">Read More</span><button class="b-object-details__cell-concealer-button">+</button>',
  '<span class="b-object-details__cell-concealer-text">Read Less</span><button class="b-object-details__cell-concealer-button">&minus;</button>'
];
